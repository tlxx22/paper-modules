...
if __name__ == "__main__":
    ...
    # 创建输入张量
    input_tensor = torch.randn(batch_size, in_channels, height, width)  # 输入张量

    # 初始化 FEM 模块
    fem = FEM(in_planes=in_channels, out_planes=out_channels, stride=1, scale=0.1, map_reduce=8)
    print(fem)
    print("\n微信公众号: AI缝合术!\n")

    # 前向传播测试
    output = fem(input_tensor)
